...
import { ShieldCheck, Loader2, CheckCircle2, AlertCircle, Info } from 'lucide-react';
    ...
    <div className="space-y-4">
      ...
      <div className="p-3.5 bg-slate-50 border border-slate-200 rounded-xl space-y-2.5">
        ...
        <input
          ...
          onChange={(e) => onChangeGoogleKeyInput(e.target.value)}
          placeholder="AIzaSy..."
      ...
      <div className="p-3.5 bg-slate-50 border border-slate-200 rounded-xl space-y-2.5">
        ...
        <input
          type="text"
          value={orsKeyInput}
          onChange={(e) => onChangeOrsKeyInput(e.target.value)}
