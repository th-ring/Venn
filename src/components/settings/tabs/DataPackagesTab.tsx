  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-white dark:bg-[#1e1f20] border-2 border-indigo-200 dark:border-indigo-900/60 rounded-2xl p-4 shadow-xs space-y-4">
        ...
        <div className="bg-orange-50/40 dark:bg-orange-950/20 border border-orange-200 dark:border-orange-800/60 rounded-xl p-3.5 space-y-3">
            ...
            <div className="flex items-start gap-2.5">
              ...
              <div>
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-[9px] font-bold px-1.5 py-0.5 rounded bg-orange-100 dark:bg-orange-900/50 text-orange-800 dark:text-orange-300 border border-orange-200 dark:border-orange-800">
                    OpenStreetMap
                  </span>
                </div>
                <div className="text-[11px] text-slate-600 dark:text-[#9aa0a6] mt-0.5">
        ...
        <div className="bg-blue-50/40 dark:bg-blue-950/20 border border-blue-200 dark:border-blue-800/60 rounded-xl p-3.5 space-y-3">
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2">
            <div className="flex items-start gap-2.5">
              ...
              <div>
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-[9px] font-bold px-1.5 py-0.5 rounded bg-blue-100 dark:bg-blue-900/50 text-blue-800 dark:text-blue-300 border border-blue-200 dark:border-blue-800">
                    DELFI & MVV
                  </span>
                </div>
                <div className="text-[11px] text-slate-600 dark:text-[#9aa0a6] mt-0.5">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-2 pt-1 text-[11px]">
            <div className="bg-white/80 dark:bg-[#282a2c] p-2 rounded-lg border border-blue-100 dark:border-blue-900/40">
              <span className="text-[10px] text-slate-400 dark:text-[#747775] block font-semibold uppercase">Haltestellen</span>
              <span className="font-bold text-slate-800 dark:text-[#e3e3e3]">{mvvMeta.stationCount} Bahnhöfe/Halte</span>
            </div>
            <div className="bg-white/80 dark:bg-[#282a2c] p-2 rounded-lg border border-blue-100 dark:border-blue-900/40">
              <span className="text-[10px] text-slate-400 dark:text-[#747775] block font-semibold uppercase">Streckenkanten</span>
              <span className="font-bold text-slate-800 dark:text-[#e3e3e3]">{mvvMeta.connectionCount} Verbindungen</span>
            </div>
            <div className="bg-white/80 dark:bg-[#282a2c] p-2 rounded-lg border border-blue-100 dark:border-blue-900/40">
              <span className="text-[10px] text-slate-400 dark:text-[#747775] block font-semibold uppercase">Version / Stand</span>
              <span className="font-bold text-slate-800 dark:text-[#e3e3e3] truncate block">{mvvMeta.version} ({mvvMeta.lastUpdated})</span>
            </div>
            <div className="bg-white/80 dark:bg-[#282a2c] p-2 rounded-lg border border-blue-100 dark:border-blue-900/40">
              <span className="text-[10px] text-slate-400 dark:text-[#747775] block font-semibold uppercase">Speicher</span>
              <span className="font-bold text-blue-700 dark:text-[#8ab4f8] flex items-center gap-1">
          ...
          <div className="pt-2 border-t border-blue-100 dark:border-[#3c4043]">
            <span className="text-[10px] font-bold text-slate-700 dark:text-[#e3e3e3] block mb-1.5">
        ...
        <div className="bg-purple-50/40 dark:bg-purple-950/20 border border-purple-200 dark:border-purple-800/60 rounded-xl p-3.5 space-y-3">
          <div className="flex items-start justify-between gap-2">
            <div className="flex items-start gap-2.5">
              ...
              <div>
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-[9px] font-bold px-1.5 py-0.5 rounded bg-purple-100 dark:bg-purple-900/50 text-purple-800 dark:text-purple-300 border border-purple-200 dark:border-purple-800">
                    dl-de/by-2-0
                  </span>
                </div>
                <div className="text-[11px] text-slate-600 dark:text-[#9aa0a6] mt-0.5">
            ...
            <span className="text-[10px] font-semibold px-2 py-0.5 rounded-full bg-emerald-100 dark:bg-emerald-900/50 text-emerald-800 dark:text-emerald-300 flex items-center gap-1 shrink-0">
              <ShieldCheck className="w-3 h-3" /> Amtlich
            </span>
          </div>

          <div className="grid grid-cols-2 sm:grid-cols-4 gap-2 pt-1 text-[11px]">
            <div className="bg-white/80 dark:bg-[#282a2c] p-2 rounded-lg border border-purple-100 dark:border-purple-900/40">
              <span className="text-[10px] text-slate-400 dark:text-[#747775] block font-semibold uppercase">Umfang</span>
              <span className="font-bold text-slate-800 dark:text-[#e3e3e3]">25 Stadtbezirke</span>
            </div>
            <div className="bg-white/80 dark:bg-[#282a2c] p-2 rounded-lg border border-purple-100 dark:border-purple-900/40">
              <span className="text-[10px] text-slate-400 dark:text-[#747775] block font-semibold uppercase">Kaltmieten</span>
              <span className="font-bold text-slate-800 dark:text-[#e3e3e3]">14,80 € – 24,50 €/m²</span>
            </div>
            <div className="bg-white/80 dark:bg-[#282a2c] p-2 rounded-lg border border-purple-100 dark:border-purple-900/40">
              <span className="text-[10px] text-slate-400 dark:text-[#747775] block font-semibold uppercase">Gültigkeit</span>
              <span className="font-bold text-slate-800 dark:text-[#e3e3e3]">Mietspiegel 2025/2026</span>
            </div>
            <div className="bg-white/80 dark:bg-[#282a2c] p-2 rounded-lg border border-purple-100 dark:border-purple-900/40">
              <span className="text-[10px] text-slate-400 dark:text-[#747775] block font-semibold uppercase">Kartenebene</span>
              <span className="font-bold text-purple-700 dark:text-purple-400">In Tab 7 konfigurierbar</span>
            </div>
          </div>
        </div>
      </div>
