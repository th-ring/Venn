  ...
  return (
    <div className="relative" ref={dropdownRef}>
      <button
        ...
        className="w-full flex items-center justify-between px-3 py-1.5 bg-slate-50 dark:bg-[#131314] hover:bg-slate-100/90 dark:hover:bg-[#282a2c] border border-slate-200/90 dark:border-[#3c4043] rounded-xl text-xs font-semibold text-slate-700 dark:text-[#c4c7c5] transition-all cursor-pointer shadow-2xs group"
      ...
      {isOpen && (
        <div className="absolute top-full left-0 right-0 mt-1.5 z-40 bg-white dark:bg-[#282a2c] rounded-2xl shadow-xl border border-slate-200 dark:border-[#3c4043] p-2 space-y-1 animate-in fade-in zoom-in-95 duration-150">
          <div className="px-2 py-1 text-[10px] font-bold text-slate-400 dark:text-[#9aa0a6] uppercase tracking-wider">
